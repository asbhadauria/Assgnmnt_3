...
class DLList {
 ...
 //he list is identified by head and tail, which point
...
Node* DLList::getNode(int i) {
 ...
 // of the linked list.
  //This function makes the code more simpler for the add and remove
  //functions.
...
int DLList::insertAt(int i, int d) {
 ...
 //Inserts a Node with data=d at the i-th position in the list.
